    ...
    {spiderManCharacters
      .map((character, index) => (
        ...
        >
          ...
          {selectedCharacter === character && (
            <div className="absolute inset-0 p-4 sm:p-6 bg-gray-900 bg-opacity-90 rounded-lg text-white overflow-auto transition-all duration-300">
              <button
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 h-full">
                ...
                <div className="w-full md:w-1/2 h-full flex flex-col justify-center p-4 sm:p-6 space-y-4">
